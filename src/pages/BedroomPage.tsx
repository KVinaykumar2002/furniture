...
export default function BedroomPage() {
  ...
  const cat = shopCategories.bedroom;
  const products = getProductsByMainCategory("bedroom", sub);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <SectionWrapper title={sub ? `${sub.replace(/-/g, " ")}` : "All Bedroom"} className="bg-white">
        {products.length === 0 ? (
